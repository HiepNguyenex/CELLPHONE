...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('/reviews',  [ReviewController::class, 'store']); // Tùy chọn
        ...
        // CHECK PURCHASED (review guard)
        Route::get('/orders/check-purchased/{productId}', [OrderController::class, 'checkPurchased']);
