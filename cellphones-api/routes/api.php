 ...
 * ⚡ SỬA: /api/login dùng Bearer token -> apiLogin (không cần CSRF)
 */
Route::post('/login',    [AuthController::class, 'apiLogin']);   // POST /api/login
...
Route::prefix('v1')->group(function () {
    ...
    // AUTH (USER) – ⚡ SỬA: dùng Bearer token
    Route::post('/register', [AuthController::class, 'register']);
    Route::post('/login',    [AuthController::class, 'apiLogin']);   // POST /api/v1/login
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('/logout',[AuthController::class, 'apiLogout']); // ⚡ SỬA: dùng token logout
