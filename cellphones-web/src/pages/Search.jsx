// ⚡ SỬA: src/pages/Search.jsx
import { useEffect, useMemo, useState } from "react";
import { Link, useLocation, useNavigate } from "react-router-dom";
import { getProducts, getBrands } from "../services/api"; // ✅ THÊM
...
export default function Search() {
  ...
  const brandIdParam = params.get("brand_id") || ""; // ✅ THÊM
  ...
  const [brandId, setBrandId] = useState(brandIdParam); // ✅ THÊM
  ...
  useEffect(() => {
    ...
    if (brandId) q.brand_id = brandId; // ✅ THÊM
  ...
  }, [keyword, categoryId, brandId, sort, page]); // ✅ THÊM brandId vào deps
    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      {!keyword && !categoryId && !brandId ? (
        <div className="bg-white rounded-xl p-6 text-gray-600 mt-4 shadow-sm">
          Hãy nhập từ khóa, chọn danh mục hoặc lọc theo thương hiệu.
        </div>
      ) : loading ? (
